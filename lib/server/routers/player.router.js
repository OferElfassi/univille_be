  ...
  _createClass(PlayerRouter, [
    ...
    },
    {
      ...
      value: function setup() {
        ...
        this.router['delete'](
          '/:playerId',
          _controllers.,playerController['delete']
        );
        this.router.put(
          '/:playerId/status',
          _controllers.pla,yerController.updateStatus
        );
        this.router.put(
          '/points/:identity/:amount',
          _controllers.p,layerController.givePoints
        );
        this.router.get(
          '/:identity/status',
          _controllers.,playerController.getStatus
        );
      },
    },
  ]);
