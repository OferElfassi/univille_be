...
var _player = require('./player.queries');
...
var statics = {
  ...
  givePoints: function givePoints(identity, amount) {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var player, score, updatedPlayer;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _this2.findOneByIdentity(identity);
          case 2:
            player = _context2.sent;
            score = player.status.score + Number(amount);
            _context2.next = 6;
            return player.updateStatus({
              score: score,
            });
          case 6:
            updatedPlayer = _context2.sent;
            return _context2.abrupt('return', updatedPlayer.status);
          case 8:
          case 'end':
  ...
  getPlayerStatus: function getPlayerStatus(identity) {
    var _this3 = this;
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _this3.findOneByIdentity(identity);
          case 2:
            player = _context3.sent;
            return _context3.abrupt('return', player.status);
          case 4:
          case 'end':
