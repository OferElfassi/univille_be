 ...
 ***************************************** */
var methods = {
  edit: function edit(missionInfo) {
  ...
  removeHint: function removeHint(hintId) {
    this.hints = this.hints.filter(function (hint) {
      return hint.id !== hintId;
    });
    return this.save();
  },
  editHint: function editHint(hintId, hintInfo) {
    var hint = this.hints.find(function (h) {
      return h.id === hintId;
    });
  ...
  editTarget: function editTarget(targetInfo) {
...
var statics = {
  ...
  //   return mission;
  // },
  filterMissions: function filterMissions(missionObj) {
    return this.find(missionObj);
  },
  createMissions: function createMissions(missionObj) {
    var newMission = new this(missionObj);
    newMission.id = newMission._id;
    return newMission.save();
  },
  deleteMission: function deleteMission(identity) {
    var _this = this;
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _this.findOneByIdentity(identity);
          case 2:
